...
//         .leftJoinAndSelect('knockoutPrediction.awayTeam', 'awayTeam')
//         .leftJoinAndSelect('knockoutPrediction.knockout', 'knockout')
//         .where('knockout.round = :roundId', {roundId: roundId === '1' ? '2' : roundId})
//         .andWhere('selectedTeam.id = :teamId', {teamId})
//         .getMany();
//
//     return {
...
//             logoUrl: team.logoUrl,
//             name: team.name,
//             isInRound: roundId === '1' ? team.knockoutsWinner.length > 0 : team.knockoutsHome.length > 0 || team.knockoutsAway.length > 0,
//             points: (roundId === '1' && team.knockoutsWinner.length > 0) ||
//             (roundId != '1' && team.knockoutsHome.length > 0 || team.knockoutsAway.length > 0) ? this.getPointsForKnockout(roundId) : 0
//         },
//         participants: kos.map(ko => {
//             return {
//                 participant: ko.participant
