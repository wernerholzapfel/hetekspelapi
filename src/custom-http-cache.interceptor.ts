...
export default class CustomHttpCacheInterceptor extends CacheInterceptor {
  ...
  trackBy(context: ExecutionContext): string | undefined {
    ...
    const excludePaths = ['/hetekspel','/match-prediction/today', 'participant/wrongkp', '/stats/participants', '/participant/mine', '/match-prediction', '/poule-prediction', '/knockout/mine'
